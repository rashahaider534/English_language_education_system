        ...
        <table style="width:100%; border-collapse:collapse; table-layout:fixed;">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center; font-size:11.5px; font-weight:700; color:rgba(1,60,88,0.45); text-transform:uppercase; padding:13px 12px; background:rgba(168,232,249,0.22); width:12%;">تاريخ الانضمام</th>
                    <th style="text-align:center; font-size:11.5px; font-weight:700; color:rgba(1,60,88,0.45); text-transform:uppercase; padding:13px 12px; background:rgba(168,232,249,0.22); width:10%;">دروس منشورة</th>
                    <th style="text-align:center; font-size:11.5px; font-weight:700; color:rgba(1,60,88,0.45); text-transform:uppercase; padding:13px 12px; background:rgba(168,232,249,0.22); width:12%;">الراتب</th>
        ...
        <div @click.stop class="modal-scroll" style="position:relative; width:100%; max-width:520px; max-height:88vh; overflow-y:auto; background:#EFFAFD; border-radius:28px; padding:32px 28px 28px; box-shadow:0 50px 110px rgba(1,42,63,0.42); font-family:'Tajawal',sans-serif;" dir="rtl">
            ...
            <form method="POST" action="{{ route('admin.permission.teacher.store') }}">
                ...
                <div style="margin-bottom:22px;">
                    ...
                    <div class="tch-field-wrap"><input type="text" name="password" placeholder="8 أحرف على الأقل"></div>
                </div>
