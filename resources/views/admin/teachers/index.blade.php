...
@push('styles')
    <style>
        ...
        .tch-filters,
        .tch-row {
            animation: teachersFadeUp 0.4s ease both;
        }

        .tch-stat:nth-child(1) {
            animation-delay: 0.02s;
        }

        .tch-stat:nth-child(2) {
            animation-delay: 0.06s;
        }

        .tch-stat:nth-child(3) {
        ...
        .tch-field-wrap input,
        .tch-field-wrap textarea {
            width: 100%;
        ...
        .modal-scroll::-webkit-scrollbar-thumb {
            background: rgba(1, 60, 88, 0.14);
            border-radius: 999px;
        }

        .modal-scroll::-webkit-scrollbar-thumb:hover {
            background: rgba(1, 60, 88, 0.24);
        }

        .modal-scroll {
            scrollbar-width: thin;
            scrollbar-color: rgba(1, 60, 88, 0.18) transparent;
        }
    </style>
@endpush

@section('content')
    <div x-data="{ createModalOpen: {{ $errors->any() ? 'true' : 'false' }}, saved: false, deactivateModalOpen: false, deactivateTargetId: null, deactivateTargetName: '' }" class="-mx-4 -my-6 px-4 py-6 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8"
        ...
        <div class="tch-hero"
            ...
            <div
                ...
                <div style="display:flex; align-items:center; gap:16px;">
                    <div
                        ...
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            ...
                            <path d="M4 19.5V5.8c0-.9.6-1.6 1.4-1.8L18 2v16.5" />
                            <path d="M18 18.5H6a2 2 0 0 0-2 2" />
                ...
                <button type="button" @click="createModalOpen = true" class="tch-create-btn"
            ...
            <div style="position:relative; display:flex; gap:14px; flex-wrap:wrap;">
                ...
                <div class="tch-stat" style="{{ $statCard }}">
                    ...
                    <div>
                        <p style="margin:0; font-size:11.5px; font-weight:600; color:rgba(255,236,176,0.85);">إجمالي
                            الأساتذة</p>
                        <p
        ...
        {{-- ============ FILTERS ============ --}}
        <form method="GET" action="{{ route('admin.teachers.index') }}" class="tch-filters"
                ...
                <tbody>
                    @forelse ($teachers as $teacher)
                        @php
                            ...
                            $initials = strtoupper(
                                substr($teacher->first_name ?? $teacher->email, 0, 1) .
        ...
        {{-- ============ CREATE MODAL ============ --}}
        <div x-show="createModalOpen" x-cloak class="modal-scroll"
            ...
            <div style="min-height:100%; display:flex; align-items:center; justify-content:center; padding:24px;">
                <div @click.stop class="modal-scroll"
                    style="position:relative; width:100%; max-width:520px; max-height:88vh; overflow-y:auto; background:#EFFAFD; border-radius:28px; padding:32px 28px 28px; box-shadow:0 50px 110px rgba(1,42,63,0.42); font-family:'Tajawal',sans-serif;"
                    dir="rtl">
                    ...
                    <form method="POST" action="{{ route('admin.permission.teacher.store') }}">
                        ...
                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:16px;">
                            <div>
                                <label
                                    ...
                                    الأول</label>
                                <div class="tch-field-wrap"><input type="text" name="first_name"
                                        placeholder="مثال: أحمد"></div>
                            </div>
                            <div>
                                <label
                                    style="display:block; font-size:12px; font-weight:700; color:#013C58; margin-bottom:6px;">الاسم
                                    الأخير</label>
                                <div class="tch-field-wrap"><input type="text" name="last_name"
                                        placeholder="مثال: خالد"></div>
                            </div>
                        </div>
                        ...
                        <div style="margin-bottom:16px;">
                            <label
                                ...
                                الإلكتروني</label>
                            <div class="tch-field-wrap"><input type="email" name="email"
                        ...
                        <div style="margin-bottom:22px;">
                            ...
                            <div class="tch-field-wrap"><input type="text" name="password"
