                        ...
                        <td style="padding:14px 16px; border-bottom:1px solid rgba(0,83,122,0.05); vertical-align:middle; text-align:center;">
                            <div style="display:flex; gap:8px; justify-content:center;">
                                ...
                                @can('manage_level_tests', 'web')
                                    <a href="{{ route('tests.level.levelTest.create', $level) }}" title="إنشاء اختبار لهالمستوى"
                                       style="display:flex; align-items:center; justify-content:center; width:33px; height:33px; border-radius:10px; background:rgba(255,211,91,0.16); color:#8A5A00; text-decoration:none;">
                                        <svg width="15.5" height="15.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="3"></rect><path d="M8 2v4M16 2v4M3 10h18"></path><path d="m9 15 2 2 4-4"></path></svg>
                                    </a>
                                @endcan
